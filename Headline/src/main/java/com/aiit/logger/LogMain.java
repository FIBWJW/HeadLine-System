package com.aiit.logger;
import java.io.UnsupportedEncodingException;
import java.util.Random;

import com.aiit.logger.pojo.*;
...
public class LogMain {
    ...
    private static JSONObject generateDisplay() {
        ...
        LogDisplay appDisplay = new LogDisplay();
    ...
    private static JSONObject generateNewsDetail() {
        ...
        LogNewsDetail appNewsDetail = new LogNewsDetail();
    ...
    private static JSONObject generateNewList() {
        ...
        LogLoading appLoading = new LogLoading();
    ...
    static public JSONObject generateCart() {
        ...
        LogCart appItemCart = new LogCart();
    ...
    static JSONObject generateStart() {
        ...
        LogStart appStart = new LogStart();
...
//      失败码
    ...
    private static JSONObject generateNotification() {
        ...
        LogNotification appNotification = new LogNotification();
    ...
    private static JSONObject generateError() {
        ...
        LogError appErrorLog = new LogError();
    ...
    private static JSONObject generateFavorites() {
        ...
        LogFavorites favorites = new LogFavorites();
    ...
    private static JSONObject generatePraise() {
        ...
        LogPraise praise = new LogPraise();
